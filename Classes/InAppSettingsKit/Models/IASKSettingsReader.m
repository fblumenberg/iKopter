...
- (void)_reinterpretBundle:(NSDictionary*)settingsBundle {
  ...
  self.title = [_bundle localizedStringForKey:[settingsBundle objectForKey:kIASKTitle] value:[settingsBundle objectForKey:kIASKTitle] table:@"Root"];
